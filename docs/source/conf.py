# -*- coding: utf-8 -*-
#
# pi2graphite documentation build configuration file, created by
...
from pi2graphite.version import VERSION
...
if is_rtd:
    ...
    htmlhelp_basename = 'pi2graphitedoc'
...
latex_documents = [
  (master_doc, 'pi2graphite.tex', u'pi2graphite Documentation',
...
man_pages = [
    (master_doc, 'pi2graphite', u'pi2graphite Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pi2graphite', u'pi2graphite Documentation',
   author, 'pi2graphite', 'One line description of project.',
   'Miscellaneous'),
]
...
linkcheck_ignore = [
    ...
    r'https?://codecov\.io.*',
    r'https?://.*readthedocs\.org.*',
    r'https?://pypi\.python\.org/pypi/pi2graphite'
]
